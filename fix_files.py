...
# Fix JobCard.jsx
jobcard = '''import React, { useState, useEffect } from "react";
...
with open("f:/SmartHire AI/frontend/src/components/JobCard.jsx", "w", encoding="utf-8") as f:
    f.write(jobcard)

with open("f:/SmartHire AI/frontend/src/pages/Bookmarks.jsx", "w", encoding="utf-8") as f:
    f.write(bookmarks)
